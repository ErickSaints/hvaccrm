  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Campañas de Marketing</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">Gestiona campañas de email y SMS</p>
        </div>
